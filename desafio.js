...
// Parte inferior da ampulheta - ok

// Função da parte inferior da ampulheta
function preencher(valorUsuario){
  ...
  // linha 2 - ok
  // espaco lateral - 8, limite hashtags - 1 (corresponde ao valor 84 passado pelo usuário)
  ...
  // linha 3 - ok
  // espaco lateral - 7, limite hashtags - 3 (corresponde ao valor 83 passado pelo usuário)
  ...
  // linha 4 - ok
  // espaco lateral - 6, limite hashtags - 5 (corresponde ao valor 80 passado pelo usuário)
  ...
  // linha 5 - ok
  // espaco lateral - 5, limite hashtags - 7 (corresponde ao valor 75 passado pelo usuário)
  ...
  // linha 6 - ok
  // espaco lateral - 4, limite hashtags - 9 (corresponde ao valor limite 68 passado pelo usuário)
  ...
  // linha 7 - ok
  // espaco lateral - 3, limite de hashtags - 11 (corresponde ao valor limite 59 passado pelo usuário)
  ...
  // linha 8 - ok
  // espaço lateral - 2, limite de hastags - 13 (corresponde ao valor limite 47 passado pelo usuário)
  ...
  // linha 9 - ok
  // espaço lateral 1; limite hashtag - 15 (corresponde ao valor limite 34 passado pelo usuário)
